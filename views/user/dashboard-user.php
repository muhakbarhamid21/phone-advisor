...
include('../../models/total_alternative_n_brand.php');
?>
...
<head>
    ...
    <title>Dashboard - User - Phone Advisor</title>
                            ...
                            <div class="card shadow-sm rounded" style="background-color: #212529; color: white;">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2 class="card-text" id="smartphone-count"><?php echo $totalAlternative; ?></h2> <!-- Replace with dynamic count -->
                                    </div>
                                    <div>
                            ...
                            <div class="card shadow-sm rounded" style="background-color: #212529; color: white;">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2 class="card-text" id="brand-count"><?php echo $totalBrand; ?></h2> <!-- Replace with dynamic count -->
                                    </div>
                                    <div>
